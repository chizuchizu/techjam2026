# Archived H200 Transformer optimization

This directory preserves the previous NVIDIA H200 work. It is self-contained
and no longer part of the repository's active ESP32 plan. Run the commands below
from this directory.
