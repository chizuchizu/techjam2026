 ...
 *   TM_MODE_EXACT - pure IEEE fp32 via libgcc soft-float (reference-quality,
 *                   slow ~50-90 s/forward on the C3).
 *   TM_MODE_FAST  - hybrid: Q15xQ12 fixed-point GEMM, fast-exp softmax,
 *                   fp32 LayerNorm/GELU. (~2-4 s/forward; validated vs the
 *                   benchmark gate: 0 failures over 25 seeds, worst abs ~8e-4.)
