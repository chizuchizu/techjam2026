...
frame; the batch of 64 inputs streams as 64 sequential
...
(see [`baseline/results/case-01_esp32_baseline_seed0_v1.log`](baseline/results/case-01_esp32_baseline_seed0_v1.log)).
A complete batch-64 total would be a derived
