# Review of `techjam2026/case-03/optimisation/esp32-baseline`
...
2026-08-29. The case-03 baseline directory is committed with this
review; see `git log` for the case-03 commit.

## What is confirmed

The teammate implementation is the benchmark-shaped Transformer body at
`B=4, S=128, D=128, H=4, F=128, L=4`, causal, with 398,592
...
| Case 3 complete forward (4 x 1.996 s) | 7.984 s |

The numerical result is confirmed on host. The device timing for this
case is not a fresh physical capture: case-03 belongs to the batch
...
Keep this large baseline as the batch-4 correctness target. The
...
multiboard dispatch of the 4 independent inputs is the better
