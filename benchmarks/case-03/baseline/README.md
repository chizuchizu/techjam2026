...
|---|---:|---|
| Current hybrid C implementation | XIAO ESP32-C3, 160 MHz | 7.984 s | Pass, worst max absolute error 1.0320e-03 (FAST) |
...
complete-forward time is 4 x 1.996 s = 7.984 s.
