...
|---|---:|---:|---:|---|
| All four layers, complete case-2 body | 1 C3 | 5.293 s | 1.00x | Pass, 5/5 seeds |
| All four layers, complete case-2 body | 2 C3s | **3.060 s** | **1.73x** | Pass, 5/5 seeds, 0 failing elements |
