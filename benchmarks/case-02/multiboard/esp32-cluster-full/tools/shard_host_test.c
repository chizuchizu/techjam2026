...
static void scatter(const float* x, TMShard* a, TMShard* b) {
    for (int i = 0; i < TM_S; i++) {
        ...
        memcpy(tm_shard_input(n) + (size_t)(i / TMS_NODES) * TM_D,
