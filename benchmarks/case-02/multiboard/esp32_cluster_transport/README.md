...
arduino-cli upload --fqbn esp32:esp32:XIAO_ESP32C3 \
  --port /dev/ttyACM0 \
  benchmarks/case-02/multiboard/esp32_cluster_transport
python3 benchmarks/case-02/multiboard/tools/benchmark_transport.py \
  --output benchmarks/case-02/multiboard/results/esp32c3_transport_v1.csv
python3 benchmarks/case-02/multiboard/tools/run_head_parallel.py \
  --workers 192.168.0.X \
  --output benchmarks/case-02/multiboard/results/esp32c3_head_parallel_v1.csv
python3 benchmarks/case-02/multiboard/tools/run_large_head_parallel.py \
  --workers 192.168.0.X \
  --scheduler round-robin \
  --output benchmarks/case-02/multiboard/results/esp32c3_large_head_tcp_v1.csv
python3 benchmarks/case-02/multiboard/tools/run_case2_norm_head_parallel.py \
  --workers 192.168.0.X,192.168.0.Y --seeds 0,1,2,3,4 \
  --output benchmarks/case-02/multiboard/results/case2_norm_head_v1.csv
python3 benchmarks/case-02/multiboard/tools/discover_esp32_workers.py \
  --workers 192.168.0.X
python3 benchmarks/case-02/multiboard/tools/run_kv_sharded.py \
  --workers 192.168.0.X \
  --output benchmarks/case-02/multiboard/results/esp32c3_kv_sharded_v1.csv
```
...
head shape. Matched four-C3 scaling is in
[`../results/FOUR_C3_PARALLEL_RESULTS.md`](../results/FOUR_C3_PARALLEL_RESULTS.md),
the earlier two-C3 result is in
...
`python3 benchmarks/case-02/multiboard/tools/export_case2_cluster_layer0.py`.
