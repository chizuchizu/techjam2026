...
| Eight-board WiFi batch | **3.963 s compute, 7.99x**, 64/64 PASS; worst `max_abs=1.4986e-3` |
...
| Per-board compute | `[15.822, 15.818]` s | `[7.917, 7.922, 7.918, 7.921]` s | `[3.957, 3.961, 3.957, 3.957, 3.961, 3.959, 3.954, 3.963]` s |
| Cluster compute wall | **15.822 s** | **7.922 s** | **3.963 s** |
| Sum of all device compute | 31.639 s | 31.679 s | 31.669 s |
| Median forward | 0.4940 s | 0.4948 s | 0.4947 s |
| Compute scaling vs one WiFi worker | **2.00x** | **3.999x** | **7.992x** |
| End-to-end wall including WiFi TCP | 28.6 s | 17.9 s | 10.4 s |
...
single-board total, the two-, four-, and eight-node clusters are about
**1.92x**, **3.84x**, and **7.68x** faster respectively.
...
- [`results_case7_eight_c3_wifi.json`](results_case7_eight_c3_wifi.json)
