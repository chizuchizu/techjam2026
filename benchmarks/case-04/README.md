...
|---|---:|---:|---|
| Current implementation (first physical capture) | **31.936 s** | 1.00x | Pass, 5/5 device seeds + 25/25 host checks |

Time/forward = 16 independent inputs x 1.996 s, the case-2
