...
built the PlatformIO firmware, flashed it to the physical XIAO ESP32-C3 (board
A, `/dev/cu.usbmodem101`), and ran seeds 0–4 end to end. The physical-device
capture is
...
The measured 0.493 s/forward matches the
...
3. Device reproduction on board A: `pio run` then
