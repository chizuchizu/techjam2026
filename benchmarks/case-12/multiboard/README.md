...
| Per-board compute | `[17.082, 17.091]` s | `[8.554, 8.554, 8.552, 8.549]` s |
| Cluster compute wall | **17.091 s** | **8.554 s** |
| Sum of all device compute | 34.172 s | 34.209 s |
| Median forward | 0.5335 s | 0.5342 s |
| Compute scaling vs one WiFi worker | **1.999x** | **3.999x** |
| End-to-end wall including WiFi TCP | 29.4 s | 15.7 s |
...
The WiFi worker's 0.5335–0.5342 s median is within 1% of the fresh optimized
USB worker's 0.5301 s. Against the best earlier optimized single-board total
of 33.879 s, the measured two- and four-node clusters are about **1.98x** and
**3.96x** faster respectively.
