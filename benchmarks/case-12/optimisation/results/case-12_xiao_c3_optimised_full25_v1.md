# Case 12 — optimised ESP32-C3 full-25-seed on-board result (v1, measured)
...
- Worst per-element absolute error over all 25 seeds: **1.1359e-03**
- Gate: `abs_err <= 0.002 OR rel_err <= 0.02` per element — **all seeds PASS**
- Per-forward time (firmware `TM` counter, 3 timed forwards):
  529015 / 528970 / 528764 us -> median **0.5290 s/forward**
- Per-seed forward time reported by the device: median **0.529 s**
- Wall time for the full 25-seed run (flash/upload/verify excluded): **62 s (00:36:28 -> 00:37:30 +08, 2026-08-30)**
...
Raw capture: `case-12_xiao_c3_optimised_full25_v1.log` (25/25 seeds
