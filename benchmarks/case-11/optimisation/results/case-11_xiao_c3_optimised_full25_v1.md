# Case 11 — optimised ESP32-C3 full-25-seed on-board result (v1, measured)

## What was measured

The maintained `optimisation/esp32-baseline` firmware for case 11 was built and
...
- Hardware: Seeed XIAO ESP32-C3, board B (`/dev/cu.usbmodem1101`)
- Case geometry: B=64, S=128, D=128, H=16, F=128, L=4, causal
...
- Worst per-element absolute error over all 25 seeds: **1.2365e-03**
- Gate: `abs_err <= 0.002 OR rel_err <= 0.02` per element — **all seeds PASS**
- Per-forward time (firmware `TM` counter, 3 timed forwards):
  2163993 / 2164242 / 2164130 us -> median **2.1641 s/forward**
- Per-seed forward time reported by the device: median **2.166 s**
- Wall time for the full 25-seed run (flash/upload/verify excluded): **144 s (00:35:45 -> 00:38:09 +08, 2026-08-30)**
...
Raw capture: `case-11_xiao_c3_optimised_full25_v1.log` (25/25 seeds
