...
(FAST worst 0.001074; EXACT worst 0.000078). On-device: **not run** — no
...
`dram0_0_seg` overflowed by 73,072 B (no firmware image).
Host-validated accuracy: FAST 0/25 seed failures (worst max_abs 0.001074);
EXACT 0/25 (worst 0.000078).
