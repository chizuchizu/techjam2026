# Case 09 — optimised ESP32-C3 full-25-seed on-board result (v1, measured)

## What was measured

The maintained `optimisation/esp32-baseline` firmware for case 09 was built and
...
- Case geometry: B=64, S=128, D=128, H=1, F=128, L=4, causal
...
- Worst per-element absolute error over all 25 seeds: **1.2368e-03**
- Gate: `abs_err <= 0.002 OR rel_err <= 0.02` per element — **all seeds PASS**
- Per-forward time (firmware `TM` counter, 3 timed forwards):
  2154695 / 2155128 / 2155441 us -> median **2.1551 s/forward**
- Per-seed forward time reported by the device: median **2.157 s**
- Wall time for the full 25-seed run (flash/upload/verify excluded): **144 s (00:33:21 -> 00:35:45 +08, 2026-08-30)**
...
Raw capture: `case-09_xiao_c3_optimised_full25_v1.log` (25/25 seeds
