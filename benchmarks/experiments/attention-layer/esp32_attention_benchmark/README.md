...
arduino-cli compile --fqbn esp32:esp32:XIAO_ESP32C3 \
  benchmarks/experiments/attention-layer/esp32_attention_benchmark
...
```sh
python3 benchmarks/experiments/attention-layer/tools/validate_e2e.py \
  --port /dev/ttyACM0 \
  --capture benchmarks/experiments/attention-layer/results/esp32c3_end_to_end_v2.log
```
