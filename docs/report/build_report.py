...
<title>Transformers on an S$7 Microcontroller</title>
...
@media print{
  ...
  @page report{size:A4 portrait;margin:14mm 15mm 16mm}
  @page landscape{size:A4 landscape;margin:14mm 15mm 16mm}
  :root{
    color-scheme:light;
    --paper:#fff;--panel:#fff;--panel-2:#e9efed;
    --ink:#0d1413;--ink-2:#4b5856;--ink-3:#6c7876;
    --rule:#d3ddda;--grid:#e2e9e7;--signal:#c2521f;--signal-soft:#fbeee7;
    --good:#0d7a4e;--warn:#8a5a00;--bad:#b3261e;
    --s1:#2a78d6;--s2:#eb6834;--s3:#1baf7a;--s4:#eda100;
    --s5:#e87ba4;--s6:#008300;--s7:#4a3aa7;--s8:#b4bcbb;
  }
  html,body{background:#fff}
  body{font-size:10.2pt;line-height:1.48;-webkit-print-color-adjust:exact;
    print-color-adjust:exact}
  #prog{display:none}
  .wrap{max-width:none;margin:0;padding:0}
  .poster-cover{display:block;page:poster;break-after:page;width:210mm;height:297mm}
  .poster-cover img{display:block;width:210mm;height:297mm;object-fit:contain}
  header.hero,.stats,section,footer{page:report}
  header.hero{padding:14mm 0 8mm;margin:0;border-bottom:1px solid var(--rule)}
  .col{max-width:156mm}
  .wide{max-width:180mm;margin:6mm auto}
  h1{font-size:31pt;margin-bottom:5mm}
  .standfirst{font-size:12pt;line-height:1.5}
  .byline{margin-top:5mm;font-size:8pt}
  h2{font-size:8pt;margin-bottom:3mm}
  h3{font-size:20pt;margin-bottom:4mm}
  h4{font-size:11.5pt;margin:6mm 0 2mm;break-after:avoid}
  p{margin-bottom:3.5mm}
  section{padding:8mm 0 4mm;border-bottom:.35pt solid var(--rule);break-before:auto}
  section>.col:first-child{break-after:avoid}
  #s8 .scroll{page:landscape;max-width:267mm;break-before:page;
    break-after:page;break-inside:avoid}
  #s8 table{font-size:6.7pt}
  #s8 th,#s8 td{padding:1mm 1.3mm}
  #s9{break-before:page}
  footer{padding:9mm 0 0;break-before:auto}
  .stats,.panel,.figure,.callout,blockquote,.scroll{break-inside:avoid}
  .stats>div{padding:4mm}
  .stats .v{font-size:19pt}
  .scroll{overflow:visible}
  table{font-size:7pt;line-height:1.3}
  th,td{padding:1.4mm 1.5mm}
  .figure figcaption{font-size:8.5pt}
...
<div class="poster-cover">
  <img src="../poster/notgpu-attention-poster.png"
       alt="NotGPU Attention project poster showing an 80 times total Case 1 speedup">
</div>
"""
...
<h1>A Transformer on an S$7 microcontroller</h1>
...
run?</strong> Not on a smaller GPU — on a microcontroller costing about seven Singapore dollars,
...
boards costs about S$56 and draws a couple of watts. If a Transformer of this size can be
